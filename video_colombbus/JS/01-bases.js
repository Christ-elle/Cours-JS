...
// Il faut utiliser l'apostrophe au début et à la fin pour que JS comprenne où commence et où finit la chaîne.
console.log('chaîne')
...
let bidule // variable s'appelant bidule mais qui n'a pas encore de contenu
...
// ces conventions s'appellent "syntaxe"
// Les noms de variable peuvent contenir des majuscules, des chiffres, des caractères accentués.
// une variable ne peut PAS  commencer par un chiffre

// let 10MentionWeb // ERREUR // INTERDIT

// CONVENTION 

// on utilise la convention dite "chameau" ou camelCase : première lettre en  en minuscule, une capitale sur chaque nouveau mot.

let dixMentionWeb

//Il existe une autre façon de nommer les variables non-utilisée en JS..
// c'est snake case : les mots sont séparés pas des tirets du 8

// NOM DE VARIABLES NON DISPONIBLES

// on ne peut pas utiliser les noms suivants :
...
console.log('nbDeVie avant incrémentation', nbDeVie)
nbDeVie++ // nbDeVie = nbDeVie + 1
// incrémentation avec la variable ++  est toujours reliée à +1
console.log(nbDeVie);

// DÉCRÉMENTATION
// Raccourci pour décrémentation (--)
let force = 1;
...
// Raccourci pour décrémentation avec valeur
