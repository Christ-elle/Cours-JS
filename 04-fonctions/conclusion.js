...
// on va créer une fonction anonyme qui ne porte pas de nom

// function() {
//     alert('Alerte excécutée par une fonction anonyme');
// }

//??? comment appeler ma fonction si elle n'as pas de nom?

// Mettre la fonction anonyme dans une variable et ça marche
...
// function() {
//     alert('Alerte !!! Seconde excécution d\'une fonction anonyme);
// }
//Pour déclancher la fonction anonyme ... (on met la fonction dans ce couple de parenthèses) (); suivie d'un couple de parenthèses
...
paragraphe2.addEventListener('click', function() {
    alert('Magnifique c\'est bien le paragraphe 2');
});
