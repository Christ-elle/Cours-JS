// Page pour EXO- saisie-obligatoire
...
document.getElementById('p1').innerHTML = 'Vous avez saisi le nombre suivant ' + votreSaisie + ' c\'est bien un nombre';

//Correction avec if et else
